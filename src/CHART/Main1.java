...
import ClientSeiteNeu.TCPClientMainMain;
//import Prozess.Sender;
//import TCPClientMainMain;
...
public class Main1 extends JPanel implements Runnable {
    ...
    public Main1(TCPClientMainMain tcp) {
        this.tcp = tcp;
//            super("CHART_TEST");
...
//              //                  chart.newValueRoom(Float         room.getTempIst(),room.getHumIst(),room.getCIst(),room.getEthylIst());
    ...
    public void setDataInChart(String text) {
...
//                   st.nextToken();
//                    st.nextToken();
            this.setTemp(Float.parseFloat(st.nextToken()));
            st.nextToken();
            this.setDamp(Float.parseFloat(st.nextToken()));
            st.nextToken();
            this.setCo2(Float.parseFloat(st.nextToken()));
            st.nextToken();
            this.setEthy(Float.parseFloat(st.nextToken()));
//          else text
        }
    }
